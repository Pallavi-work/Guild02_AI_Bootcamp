...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/Pallavi-work/Guild02_AI_Bootcamp/master/TicTacToeAppFolder/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: 0.9882352941176471
exported_pipeline = GradientBoostingClassifier(learning_rate=1.0, max_depth=1, max_features=0.8, min_samples_leaf=11, min_samples_split=3, n_estimators=100, subsample=0.8500000000000001)
...
title = 'TicTacToeGame'
encoder_location = ''
target_encoder_location = 'https://github.com/Pallavi-work/Guild02_AI_Bootcamp/blob/master/TicTacToeAppFolder/target_encoder.pkl?raw=true'
